"""Views to add players to a CFC Rated tournament."""
...
def add_player_database_view(request: HttpRequest) -> HttpResponse:
    ...
    try:
        ...
        player = Player.create(player_name, player_cfc_id)
